import { Ionicons } from "@expo/vector-icons"; // pencil/edit icon
...
const styles = StyleSheet.create({
  ...
  row: {
    ...
    borderBottomColor: ColorPallete.first,
  },
  label: {
    fontSize: 18,
    color: "green",
  ...
  const renderRow = (key) => (
    <View style={styles.row} key={key}>
      ...
      <TouchableOpacity style={styles.editBtn} onPress={() => openModal(key)}>
        <Ionicons name="pencil" size={20} color={ColorPallete.fourth} />
      </TouchableOpacity>
    </View>
  );
