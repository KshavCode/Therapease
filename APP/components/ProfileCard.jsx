...
const fetchData = (id, role) => {
  ...
  if (role === "patient") {
    jsonData = {
      ...
      weight: "60kg",
      gender: "Male",
      bio: "ldjfdsjflkdjslkf\njksjfslkjdflksjfljskdf\nkjsdjflskjflksjdlfkjsdlfkjlkjlk",
      location: "New Delhi",
      activity: "Mediocre",
      joined_on: "23 August 2024",
      badges: "Image Data Here",
    };
  } else {
    jsonData = {
      id: 1,
      name: "ABC",
      speciality: "Upper Body",
      rating: `4.3`,
      experience: "8y",
      gender: "Female",
      bio: "Best of the Best\nMakes your soul clean and body rest.",
      location: "Faridabad",
      avaibility: "Weekdays",
      joined_on: "18 March 2023",
      email: "abc_220321@gmail.com",
    };
  }
  return jsonData;
};
...
export default function UserCard({ id, role }) {
  ...
  const handleBookAppointment = () => {
    const nameLabel = role === "patient" ? data.name : `Dr. ${data.name}`;
    Alert.alert(
      "Confirm Booking",
      `Do you want to book an appointment with ${nameLabel}?`,
      [
  ...
  if (role === "patient") {
    return (
      <View style={styles.card}>
        ...
        <View
          style={[styles.borderBox2, { height: "25%", justifyContent: "flex-start" }]}
        >
